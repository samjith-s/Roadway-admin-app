...
import 'package:admin/view/vehicles/cars/widgets/total_cars_gridview.dart';
...
class CarsCollectionScreen extends StatelessWidget {
  const CarsCollectionScreen({Key? key}) : super(key: key);
          ...
          children: [
            ...
            BlocBuilder<VehiclesBloc, VehiclesState>(
              builder: (context, state) {
                ...
                return ShowTotoalCarsGridView(state: state);
              },
            ),
          ],
        ),
